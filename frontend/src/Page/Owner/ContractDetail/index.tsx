        ...
        <>
            <div style={{ textAlign: "left" }}>
                ...
                <div style={{padding: "30px"}}>
                    <p>
                        Hôm nay, ngày{" "}
                        {contactDetailData?.createdDate.getDate() || "......"} tháng{" "}
                        {contactDetailData?.createdDate.getMonth() || "......"} năm{" "}
                        {contactDetailData?.createdDate.getFullYear() || "......"} tại địa
                    ...
                    <p>
                        ...
                        {contactDetailData?.dateStart.getDate() || "......"} tháng{" "}
                        {contactDetailData?.dateStart.getMonth() || "......"} năm{" "}
                        {contactDetailData?.dateStart.getFullYear() || "......"} đến hết
                        ngày {contactDetailData?.dateEnd.getDate() || "......"} tháng{" "}
                        {contactDetailData?.dateEnd.getMonth() || "......"} năm{" "}
                        {contactDetailData?.dateEnd.getFullYear() || "......"}
                    </p>
                    <br />
                    ...
                    {contactDetailData?.contractTerm || "......"} <br />
